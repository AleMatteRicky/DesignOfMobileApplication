...
private val LightColors = lightColorScheme(
    ...
    secondary = Color.hsl(0f, 0.01f, 0.30f), // secondary text color
    inversePrimary = Color.hsl(0f, 0.01f, 1f), //used for selected text and icons
...
private val DarkColors = darkColorScheme(
    primary = Color.hsl(0f, 0.01f, 0.93f),   // primary text color
    secondary = Color.hsl(0f, 0.01f, 0.70f), // secondary text color
    inversePrimary = Color.hsl(0f, 0.01f, 0.93f), //used for selected text and icons
    onBackground = Color.hsl(0f, 0.01f, 0f), //onBackground equal to background
    background = Color.hsl(0f, 0.01f, 0f),
    onPrimaryContainer = Color.hsl(0f, 0.01f, 0.07f), // primary info panel
    onSurface = Color.hsl(0f, 0.01f, 0.15f), // used for selected or interactable components
    inverseSurface = Color.hsl(0f, 0.01f, 0f), //used for download track
    tertiaryContainer = Color.hsl(0f, 0.01f, 0.15f), //used only for search bar (weather)
