...
data class TranslationUiState(
    ...
    val downloadedLanguageTags: MutableStateFlow<List<String>> = MutableStateFlow(emptyList()),
    val notDownloadedLanguageTags: MutableStateFlow<List<String>> = MutableStateFlow(emptyList()),
